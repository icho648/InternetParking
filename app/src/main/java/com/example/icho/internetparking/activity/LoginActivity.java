...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener,CompoundButton.OnCheckedChangeListener{
    ...
    private ProgressDialog progressDialog; //显示正在加载的对话框
    Button button_test;
...
//       return password;   //解码一下
    ...
    private void login() {
        ...
        Thread loginRunnable = new Thread() {
            ...
            public void run() {
                ...
                //判断账号和密码
                if (getAccount().equals("icho") && getPassword().equals("wyc19980923")) {
                    showToast("登录成功");
    ...
    public void showLoading() {
        if (progressDialog == null) {
            progressDialog =ProgressDialog.show(this,"提示","正在登陆中",true,true);
        }
    }
